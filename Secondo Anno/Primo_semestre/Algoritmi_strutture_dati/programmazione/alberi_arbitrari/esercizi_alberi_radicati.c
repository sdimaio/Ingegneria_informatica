...
litem* cammino_lista(albero t, int n){
...
/* non funziona, da controllare dopo gli esami
PSEUDOCODICE DI QUELLA CHE DOVREBBE FUNZIONARE
PARENTELA(t, n1, n2)
L1 = CAMMINO(t,n1)
L2 = CAMMINO(t,n2)
 x1 = L1.head
...
x2_next = x2.next
if ( x1.info == x2.info )
REMOVE_HEAD(L1) // x1 e' sempre il primo elemento di L1
REMOVE_HEAD(L2)
else
break
x1 = x1_next // forse x1 non esiste piu'
x2 = x2_next
 return LUNGHEZZA(L1)+LUNGHEZZA(L2)
 =====================================
int parentela(albero t, nodo* n1, nodo* n2){
    ...
    if(t==NULL)
     ...
     litem* cammino_parentela1 = cammino_lista(t, n1->info);
     litem* cammino_parentela2 = cammino_lista(t, n2->info);

     while(cammino_parentela1 != NULL && cammino_parentela2 != NULL){
