...
public class CostantiSimulazione {
	 ...
	 */
	static final public int NUMERO_AUTO_PER_TIPOLOGIA = 3;
	...
	/**
	 * Il numero totale di destinazioni coperte dalle vetture gialle
	 */
	static final public int N_DESTINAZIONI_GIALLE = 3;
