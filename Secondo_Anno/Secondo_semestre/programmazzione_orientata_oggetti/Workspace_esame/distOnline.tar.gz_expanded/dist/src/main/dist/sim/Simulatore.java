...
public class Simulatore {
	...
	private void creaPopolazione() {
		for(int i=0; i<NUMERO_INIZIALE_PER_TIPOLOGIA; i++) {
			this.ambiente.add(this.creaPersonaDistratta());
			this.ambiente.add(this.creaPersonaAttenta());
		}
	}

	public Distratta creaPersonaDistratta() {
		return new Distratta(this.ambiente);
	}
	
	public Attenta creaPersonaAttenta() {
