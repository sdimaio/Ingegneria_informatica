...
public class PersonaTest {
	...
	@Test
	public void testIdProgressiviPerPersoneStessoTipoDiv() {
	...
	@Test
	public void testIdProgressiviPerPersoneStessoTipoA() {
		// DA RIVEDERE VEDI DOMANDA 2a
	...
	@Test
	public void testIdProgressiviPerPersoneStessoTipoD() {
		// DA RIVEDERE VEDI DOMANDA 2a
	...
	@Test
	public void testIdProgressiviPerPersoneTipoDiverse() {
		// DA COMPLETARE VEDI DOMANDA 2a
		// Tipi di persone diverse hanno due serie di id distinte
		assertEquals("Gli id sono progressivi base 0 per ciascun tipo dinamico!", 3, new Attenta(this.ambiente).getId());
		assertEquals("Gli id sono progressivi base 0 per ciascun tipo dinamico!", 3, new Distratta(this.ambiente).getId());
	}
